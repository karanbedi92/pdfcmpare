...
public class PdfComparator<T extends CompareResultImpl> {
    ...
    private RenderingHints createDefaultRenderingHints() {
        RenderingHints r = new RenderingHints((Map)null);
        r.put(RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
        ...
        r.put(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_OFF );
        r.put(RenderingHints.KEY_DITHERING, RenderingHints.VALUE_DITHER_DISABLE );
    ...
    private void compare(final PDDocument expectedDocument, final PDDocument actualDocument) throws IOException {
        ...
        expectedPdfRenderer.setRenderingHints(createDefaultRenderingHints());
        expectedPdfRenderer.setSubsamplingAllowed(true);
        ...
        actualPdfRenderer.setRenderingHints(createDefaultRenderingHints());
        actualPdfRenderer.setSubsamplingAllowed(true);
