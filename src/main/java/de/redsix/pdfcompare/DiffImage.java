...
public class DiffImage {
    ...
    public void diffImages() {
        ...
        System.out.println("Expected ==== > height : "+expectedImageHeight+"width : "+expectedImageWidth);
        System.out.println("Actual ==== > height : "+actualImageHeight+"width : "+actualImageWidth);
